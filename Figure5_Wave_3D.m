...
%--------------------------------------------------------------------------
% Step 1. rawdata (imaging & CSM + PSF calibration scan) reading
% -------------------------------------------------------------------------
%---- Full FOV calibration data

load /home/amax/ReducedFOVCode/ReproducingMaterial/data/WaveRefScan_fullFOV.mat
...
RAW_redFOV = readcfl('/home/amax/ReducedFOVCode/ReproducingMaterial/data/rawdata_redFOV');
